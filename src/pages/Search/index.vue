...
export default {
  ...
  methods: {
       ...
       setOrder(flag){  //"1" /2
          ...
          // 取出原本的orderFlag 和 orderType
          let [orderFlag,orderType] =this.options.order.split(':')
          // 点击当前的排序项：切换排序方式(排序项不变)
          if(flag === orderFlag){
              orderType = orderType==='asc'?'desc':'asc'
          }else{    // 点击当前的排序项：切换排序项，排序方式为降序
             orderFlag = flag
             orderType = 'desc'
      ...
      */
      ...
      removeKeyword(){
        ...
        // this.getProductList()
        // 应该重新跳转到当前search,干掉关键字的params参数参数
